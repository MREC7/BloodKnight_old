...
define config.name = _("Blood Knight")
...
define config.version = "0.30"


## Текст, помещённый в экран "Об игре". Поместите текст между тройными скобками.
## Для отделения абзацев оставляйте между ними пустую строку.

define gui.about = _p("""Разработчики:

Сюжет: Chaos.

Программирование: Mike77.
""")
...
define config.main_menu_music = "cave.mp3"
...
define config.save_directory = "BloodKnight-1689394707"
